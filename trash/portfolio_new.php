      ...
      <div class="drawer mdl-layout__drawer mdl-color--blue-grey-900 mdl-color-text--blue-grey-50">
        ...
        <div class="mdl-grid content">
          ...
          <div class="mdl-cell--12-col mdl-grid">
            <div class="mdl-shadow--2dp mdl-cell mdl-cell--4-col mdl-grid tip-container"><span class="tip-header">Social Forecast</span><br/>
              Bitcoin - <?php echo $socialtrendb;?><br>
              Ethereum - <?php echo $socialtrende;?><br>
              Ripple - <?php echo $socialtrendr;?>
            </div>
            <div class="mdl-shadow--2dp mdl-cell mdl-cell--4-col mdl-grid tip-container"><span class="tip-header">Economic Forecast</span><br/>
            ...
            <div class="mdl-shadow--2dp mdl-cell mdl-cell--4-col mdl-grid tip-container"><span class="tip-header">Hey! Here's a tip to improve your profit!!</span><br/>
